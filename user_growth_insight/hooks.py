...
app_include_css = ["/assets/user_growth_insight/css/user_growth_dashboard.css?v=20260701-fit"]
app_include_js = ["/assets/user_growth_insight/js/desk_shortcuts.js?v=20260701-fit"]
